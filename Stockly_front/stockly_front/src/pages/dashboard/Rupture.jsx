...
function Rupture() {
    ...
    useEffect(() => {
        fetch(`${API_URL}/produits/rupture`)
            ...
            .catch(error => {
                console.error('Erreur lors de la récupération des statistiques des produits en rupture de stock: ', error)
            })
    });
            ...
            <div id="kt_app_toolbar" className="app-toolbar pt-7 pt-lg-10">
                <div className="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div className="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <h1 className="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Produits en rupture</h1>
                    </div>
                </div>
            </div>
