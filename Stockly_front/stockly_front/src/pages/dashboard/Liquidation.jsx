                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="d-flex justify-content-start flex-column">
                                                            <a href="#" className="text-gray-900 fw-bold text-hover-primary fs-6">{liquidation.Libelle_Categorie}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="#" className="text-gray-900 fw-bold text-hover-primary fs-6">{liquidation.Nom_Produit}</a>
                                                </td>
                                                <td className="text-end">
                                                    <div className="d-flex flex-column w-100 me-2">
                                                        <div className="d-flex flex-stack mb-2">
                                                            <span className="text-gray-700 fw-bold text-hover-primary d-block fs-6">{liquidation.Prix_Produit}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="text-end">
                                                    <div className="d-flex flex-column w-100 me-2">
                                                        <div className="d-flex flex-stack mb-2">
                                                            <span className="text-gray-700 fw-bold text-hover-primary d-block fs-6">{liquidation.Quantite_stock}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="text-end">
                                                    <div className="d-flex flex-column w-100 me-2">
                                                        <div className="d-flex flex-stack mb-2">
                                                            <span className="text-danger fw-bold d-block fs-6">{formatDate(liquidation.Date_Peremption)}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
